/*
 * Copyright (C) 2013 Vanir && The Android Open Source Project
 *
...
public class VanirDreamEngine extends Activity {
    ...
    public static class Dream extends FrameLayout
    {
        ...
        public Dream(Context context, AttributeSet as) {
            ...
            mNumberOfMobs = Settings.System.getInt(context.getContentResolver(),
                    VanirDreamSettings.COUNT, VanirDreamSettings.DEFAULT_NUM_MOB);
            mIsRotationEnabled = Settings.System.getInt(context.getContentResolver(),
                    VanirDreamSettings.ROTATION, 1) == 1 ? true : false;
            DEBUG = (Settings.System.getInt(context.getContentResolver(),
                    VanirDreamSettings.DEBUG, 0) == 1 ? true : false);
            setWillNotDraw(!DEBUG);

            //to do: add vanir background here as well?
        }
